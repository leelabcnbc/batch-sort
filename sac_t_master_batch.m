function unit_num=sac_t_master_batch()
...
%   PCA=0;
%end
N=N/1;%Penalty_factors(get(Handles.Penalty,'Value'));
g=10;
...
[Pj,mu,Sigma,nu,Z,U,M]=sac_t_algorithm_batch(Pj,mu,Sigma,nu,N,10,'regular');%10 iterations of regular EM
[Pj,mu,Sigma,nu,Z,U,M]=sac_t_algorithm_batch(Pj,mu,Sigma,nu,N,500,'agglomerate');%modified Mario algorithm
[Pj,mu,Sigma,nu,Z,U,M]=sac_t_algorithm_batch(Pj,mu,Sigma,nu,N,10,'regular');%10 iterations of regular EM
g=length(Pj);
ZU=Z.*U;
